  ...
  return <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        <div className={`grid gap-3 md:gap-6 ${isMobile ? 'grid-cols-2' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'}`}>
          {optimizedData.map(dayData => <ExpandedDayCard key={dayData.day} day={dayData.day} date={dayData.date} isToday={dayData.day === currentDayNumber} chapters={dayData.chapters} progressPercentage={dayData.progressPercentage} isMobile={isMobile} />)}
        </div>
      </div>
