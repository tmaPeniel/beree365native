    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="bg-card p-4 md:p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="md:text-2xl font-bold mb-1 md:mb-2 text-base">
              {`Le Tour de ma Bible en ${effectivePlanDuration} jours`}
            </h1>
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div className={`${isMobile ? "" : "grid grid-cols-2 gap-6"}`}>
          <PlanDates startDate={startDate} endDate={endDate} remainingDays={stats.remainingDays} />
