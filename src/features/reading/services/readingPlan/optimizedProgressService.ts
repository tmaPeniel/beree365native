...
import { calculateUserBadges, getUserBadges, Badge } from '@/features/profile/services/badgeService';
...
export const optimizedToggleChapterStatus = async (
  ...
  try {
    ...
    const result = await newOptimizedToggle(userId, chapterId, currentStatus, dayNumber ?? 1);
